...
export const Amenities = [
    { imgUrl: '/assets/images/icons/house.svg', name: 'Poo', selected: false, type: AmenityTags.Poo },
    { imgUrl: '/assets/images/icons/house.svg', name: 'Hot tube', selected: false, type: AmenityTags.HotTube },
    { imgUrl: '/assets/images/icons/house.svg', name: 'Patio', selected: false, type: AmenityTags.Patio },
    { imgUrl: '/assets/images/icons/house.svg', name: 'BBQ grill', selected: false, type: AmenityTags.BBQGrill },
